...
global.packname = process.env.PACK_NAME === undefined ? 'FOLLOW MY INSTA' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'SIMRAN BOT' : process.env.STICKER_AUTHOR_NAME
